...
VM_BASE_NAME="Primatectestbench"
VM_HOSTNAME="primatecTB"
...
GUEST_PASSWORD_SEED="Da/Bin6we2OOJCVD"
...
GUEST_ENCRYPTED_PW=$(mkpasswd -m sha-512 ${GUEST_PASSWORD} ${GUEST_PASSWORD_SEED})
GUEST_ENCRYPTED_PW=${GUEST_ENCRYPTED_PW//\//\\/}
...
DAILY_ISO_CHECKSUM=`curl https://cdimage.ubuntu.com/ubuntu-server/jammy/daily-live/current/SHA256SUMS | *jammy-live-server-amd64.iso | awk '{print $1}'`
...
if [ `uname -s` == "Darwin" ]; then
  ...
  sed -i "" "s|/Users/SBS/Downloads|${DOWNLOADS_FOLDER}|g" "ubuntu-2204-daily.pkr.hcl"
